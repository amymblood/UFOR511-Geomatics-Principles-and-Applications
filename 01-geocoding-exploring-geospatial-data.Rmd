...
**Step 2:** Open ArcGIS Pro, create a new map (name it “Lab-1”) and add the street-trees data to the map. You can add the data by navigating to the Map tab, then Add Data > Data. Select the street-trees file. You should see street-trees in the Contents Pane to the left, and your map should now have points representing street trees in the chosen neighbourhood.

**Step 3:** Right-click street-trees and select "Export Features." 
...
- Roads symbolized - Necessary map components (title, legend, scale bar, north arrow, student name and number, coordinate system)
