...
- Answers to any questions posed in the lab handout submitted through Canvas. 
...
You can also use the Locate tool to Search an address using the ArcGISWorld Geocoding Service. Type in the address of Queen Elizabeth Park (4600 Cambie St, Vancouver) and notice the map highlights near the park! The ArcGIS World Geocoding Service will consume credits through your ArcGIS account, so it is not the most cost-effective way to geocode many addresses.
...
- Coordinate-created street tree points and address-created street tree points (symbolized differently from each other!) 
- Roads symbolized
...
**Step 1:** To create a map, select "New Layout" under the Insert tab. Choose 11"x17" (portrait or landscape, whichever you prefer). 
To the right of your Contents Pane, a Layout tab should have opened next to your Map tab. You can toggle between the two of them.

With the Layout open, click the Insert Tab. From here, you will be able to insert all of your necessary map components. Click Map Frame and select the one to the right of the default extent. Within your layout, create a rectangle with your mouse. This rectangle should have populated with the map you created.

**Step 2:** Use the insert tab to draw in the other map components, such as the scale bar, legend, and North Arrow.    

**Step 3:** Export your map to PDF and upload it to Canvas along with the other lab questions. To export the map, click the Share Tab at the top, then select Export Layout. Choose PDF and save it to somewhere you can readily find it.
